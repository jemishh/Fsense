...
public class AvatarImageBehaviorTest extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public AvatarImageBehaviorTest(
    ...
    public boolean onDependentViewChanged(
        ...
        //make changes in divider to adjust the final position of image
        final float distanceXToSubtract = progress * amountToMoveXPosition / 100;
        final float distanceYToSubtract = progress * amountToMoveYPosition / 93;
